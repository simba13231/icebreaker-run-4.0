...
export class Renderer {
  ...
  renderBoat(boat) {
    ...
    hullGradient.addColorStop(0, c.BOAT_HULL_SHADE);
    hullGradient.addColorStop(0.5, c.BOAT_HULL);
    hullGradient.addColorStop(1, c.BOAT_HULL_SHADE);
